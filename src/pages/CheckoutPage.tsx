        ...
        <div className="OrderItemList shadow-xl flex flex-col items-stretch lg:w-2/3 sm:w-full h-full rounded-xl px-4">
          {orderItemsState.map((item) => (
            <div
              ...
              className="orderItem flex-1 h-full flex-col py-4 xl:max-h-[300px] border-b-2 border-gray-400 px-4"
            >
              <div className="orderItemTop flex justify-between h-[60px]">
                <div className="orderItemImage w-[15%] overflow-hidden rounded-xl">
                  <img
                    ...
                    className="Image aspect-w-1 aspect-h-1 w-32 h-32 object-cover"
                  />
                </div>
