                        ...
                        <div className='details mt-6 flex flex-col space-y-4'>
                            <form className="flex flex-col md: space-y-4">
                                <div className="flex flex-row items-center">
                                    ...
                                    <input id="name" className="flex-1 rounded-xl border-2 border-black p-1" type="text" />
                                </div>
                                <div className="flex flex-row items-center">
                                    <label className="font-normal w-32">Contact No</label>
                                    <input id="contact" className="flex-1 rounded-xl border-2 border-black p-1" type="text" />
                                </div>
                                <div className="flex flex-row items-center">
                                    <label className=" font-normal w-32">Email Address</label>
                                    <input id="email" className="flex-1 rounded-xl border-2 border-black p-1" type="email" />
                                </div>
                            ...
                            <div className="Payment-options flex flex-row items-center align-start  flex-1 w-full">
                                ...
                                <div className='flex flex-col space-y-4 flex-grow-0  w-full'>
                                    <div className='flex flex-row w-full '>
                                        ...
                                        <input id="PaymentOption1" className="flex-[5] flex rounded-tr-xl rounded-br-xl border-2 border-black p-1    " />
                                    </div>
                                    <div className='flex flex-row w-full'>
