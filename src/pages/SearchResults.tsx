...
const SearchResults = () => {
    ...
    return (
        <div className="app-wrapper flex flex-col items-center justify-start min-h-screen w-full overflow-y-visible px-3">
            ...
            <div className='search-wrapper flex flex-col h-full w-full border-green-500 border-2 p-4 space-y-6'>
                ...
                <div className='search-results flex flex-[3] bg-gray-50 drop-shadow-xl rounded-xl p-8 flex-col'>
                    <h1>Search Results for "ITEM"</h1>
                    <div className=' result-container w-full flex items-center'>

                        <div className='w-56 space-y-3 flex flex-col'>
