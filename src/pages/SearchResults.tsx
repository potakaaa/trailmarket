  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="app-wrapper flex flex-col items-center justify-start min-h-screen w-full overflow-y-visible px-3">
        <div className="search-wrapper flex flex-col h-full w-full space-y-6 md:flex-row space-x-2">
          <div className="filter-sort flex flex-[1] bg-gray-50 h-full drop-shadow-xl rounded-xl p-8 z-10 md:z-0 justify-center">
            ...
            <div className=" result-container w-full flex items-center justify-center md:grid md:grid-cols-3 md:gap-4">
              <div className="PRODUCT-CONTAINER w-full space-y-3 flex flex-col">
                ...
                <div className="flex flex-[2] bg-zinc-900 rounded-xl p-4 flex-col">
                  <h2 className="text-white text-xl">HAPPY BIRTHDAY</h2>
                  <h2 className="text-white font-normal text-sm">RALD</h2>
                </div>
              </div>
            </div>
          </div>
